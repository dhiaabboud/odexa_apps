    ...
    def create(self, values_list):
        ...
        if self.env.context:
            for values in values_list:
                ...
                if discuss_channel and discuss_channel.facebook_channel:
                    values["message_type"] = 'facebook_msgs'
                elif discuss_channel and discuss_channel.instagram_channel:
                    values["message_type"] = 'insta_msgs'
                elif discuss_channel and discuss_channel.whatsapp_channel:
